        ...
        if (location != null) {
            ...
            String date1 = DateFormat.getDateInstance(DateFormat.FULL).format(calendar.getTime());
                        ...
                        try {
                            ...
                            reftoTableone1 = FirebaseDatabase.getInstance().getReference("New Locations").child(android_id);
                            ...
                            reftoTableone2 = FirebaseDatabase.getInstance().getReference("New Date").child(android_id);

                            HashMap<String, String> map2 = new HashMap<String, String>();
                            map2.put("date", date1);
                            reftoTableone2.setValue(map2);
                            DatabaseReference reftoTableone=null;
                            reftoTableone = FirebaseDatabase.getInstance().getReference("Locations").child(android_id).child(date1).child(add);
                            ...
                            reftoTableone.setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    DatabaseReference ref = FirebaseDatabase.getInstance().getReference("New Locations").child(android_id);
                                    ref.keepSynced(true);
                                    ref.addChildEventListener(new ChildEventListener() {
                                        ...
                                        public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                                          //  Toast.makeText(LocationMonitoringService.this, "child changed", Toast.LENGTH_SHORT).show();
                                            DatabaseReference ref = null;
                                            ref = FirebaseDatabase.getInstance().getReference("Locations").child(android_id).child(date1).child(add);
                                    ...
                                    DatabaseReference ref3 = FirebaseDatabase.getInstance().getReference("New Date").child(android_id);
...
//                                @Override
//                                public void run() {
//                                    Intent dialogIntent = new Intent(LocationMonitoringService.this, MainActivity.class);
//                                    dialogIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                                    dialogIntent.putExtra("ok","ok");
...
//
    ...
    private void startForegroundService(){
        String NOTIFICATION_CHANNEL_ID = "com.app.employee";
        ...
        Notification notification = notificationBuilder.setOngoing(true)
                ...
                .setCategory(Notification.CATEGORY_SERVICE).setSound(null)
                .build();
